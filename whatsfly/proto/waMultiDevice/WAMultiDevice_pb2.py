...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "waMultiDevice.WAMultiDevice_pb2", globals()
)
if _descriptor._USE_C_DESCRIPTORS == False:
    DESCRIPTOR._options = None
    DESCRIPTOR._serialized_options = b"Z'go.mau.fi/whatsmeow/proto/waMultiDevice"
    _MULTIDEVICE_APPLICATIONDATA_APPSTATESYNCKEY_APPSTATESYNCKEYDATA_APPSTATESYNCKEYFINGERPRINT.fields_by_name[
        "deviceIndexes"
    ]._options = None
    _MULTIDEVICE_APPLICATIONDATA_APPSTATESYNCKEY_APPSTATESYNCKEYDATA_APPSTATESYNCKEYFINGERPRINT.fields_by_name[
        "deviceIndexes"
    ...
    _MULTIDEVICE_APPLICATIONDATA_APPSTATESYNCKEY_APPSTATESYNCKEYDATA._serialized_start = (
        978
    )
    _MULTIDEVICE_APPLICATIONDATA_APPSTATESYNCKEY_APPSTATESYNCKEYDATA._serialized_end = (
        1257
    )
    _MULTIDEVICE_APPLICATIONDATA_APPSTATESYNCKEY_APPSTATESYNCKEYDATA_APPSTATESYNCKEYFINGERPRINT._serialized_start = (
        1165
    )
    _MULTIDEVICE_APPLICATIONDATA_APPSTATESYNCKEY_APPSTATESYNCKEYDATA_APPSTATESYNCKEYFINGERPRINT._serialized_end = (
        1257
    )
