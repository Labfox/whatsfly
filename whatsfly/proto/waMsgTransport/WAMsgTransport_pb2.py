...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "waMsgTransport.WAMsgTransport_pb2", globals()
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _MESSAGETRANSPORT_PROTOCOL_ANCILLARY_BACKUPDIRECTIVE_ACTIONTYPE._serialized_start = (
        1012
    )
    _MESSAGETRANSPORT_PROTOCOL_ANCILLARY_BACKUPDIRECTIVE_ACTIONTYPE._serialized_end = (
        1081
    )
    ...
    _MESSAGETRANSPORT_PROTOCOL_ANCILLARY_ICDCPARTICIPANTDEVICES_ICDCIDENTITYLISTDESCRIPTION._serialized_start = (
        1399
    )
    _MESSAGETRANSPORT_PROTOCOL_ANCILLARY_ICDCPARTICIPANTDEVICES_ICDCIDENTITYLISTDESCRIPTION._serialized_end = (
        1514
    )
    _MESSAGETRANSPORT_PROTOCOL_ANCILLARY_SENDERKEYDISTRIBUTIONMESSAGE._serialized_start = (
        1516
    )
    _MESSAGETRANSPORT_PROTOCOL_ANCILLARY_SENDERKEYDISTRIBUTIONMESSAGE._serialized_end = (
        1608
    )
