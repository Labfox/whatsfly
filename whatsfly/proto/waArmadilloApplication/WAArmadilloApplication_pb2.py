...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "waArmadilloApplication.WAArmadilloApplication_pb2", globals()
)
if _descriptor._USE_C_DESCRIPTORS == False:
    DESCRIPTOR._options = None
    DESCRIPTOR._serialized_options = (
        b"Z0go.mau.fi/whatsmeow/proto/waArmadilloApplication"
    )
    ...
    _ARMADILLO_APPLICATIONDATA_METADATASYNCACTION_SYNCMESSAGEACTION._serialized_start = (
        1802
    )
    _ARMADILLO_APPLICATIONDATA_METADATASYNCACTION_SYNCMESSAGEACTION._serialized_end = (
        2023
    )
    _ARMADILLO_APPLICATIONDATA_METADATASYNCACTION_SYNCMESSAGEACTION_ACTIONMESSAGEDELETE._serialized_start = (
        1992
    )
    _ARMADILLO_APPLICATIONDATA_METADATASYNCACTION_SYNCMESSAGEACTION_ACTIONMESSAGEDELETE._serialized_end = (
        2013
    )
    _ARMADILLO_APPLICATIONDATA_METADATASYNCACTION_SYNCCHATACTION._serialized_start = (
        2026
    )
    _ARMADILLO_APPLICATIONDATA_METADATASYNCACTION_SYNCCHATACTION._serialized_end = 2877
    _ARMADILLO_APPLICATIONDATA_METADATASYNCACTION_SYNCCHATACTION_ACTIONCHATREAD._serialized_start = (
        2431
    )
    _ARMADILLO_APPLICATIONDATA_METADATASYNCACTION_SYNCCHATACTION_ACTIONCHATREAD._serialized_end = (
        2576
    )
    _ARMADILLO_APPLICATIONDATA_METADATASYNCACTION_SYNCCHATACTION_ACTIONCHATDELETE._serialized_start = (
        2579
    )
    _ARMADILLO_APPLICATIONDATA_METADATASYNCACTION_SYNCCHATACTION_ACTIONCHATDELETE._serialized_end = (
        2712
    )
    _ARMADILLO_APPLICATIONDATA_METADATASYNCACTION_SYNCCHATACTION_ACTIONCHATARCHIVE._serialized_start = (
        2715
    )
    _ARMADILLO_APPLICATIONDATA_METADATASYNCACTION_SYNCCHATACTION_ACTIONCHATARCHIVE._serialized_end = (
        2867
    )
    _ARMADILLO_APPLICATIONDATA_METADATASYNCACTION_SYNCACTIONMESSAGE._serialized_start = (
        2879
    )
    _ARMADILLO_APPLICATIONDATA_METADATASYNCACTION_SYNCACTIONMESSAGE._serialized_end = (
        2952
    )
    _ARMADILLO_APPLICATIONDATA_METADATASYNCACTION_SYNCACTIONMESSAGERANGE._serialized_start = (
        2955
    )
    _ARMADILLO_APPLICATIONDATA_METADATASYNCACTION_SYNCACTIONMESSAGERANGE._serialized_end = (
        3151
    )
