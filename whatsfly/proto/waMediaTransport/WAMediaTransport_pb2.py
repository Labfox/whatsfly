...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "waMediaTransport.WAMediaTransport_pb2", globals()
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _AUDIOTRANSPORT_ANCILLARY_AVATARAUDIO_DOWNLOADABLEAVATARANIMATIONS._serialized_start = (
        2217
    )
    _AUDIOTRANSPORT_ANCILLARY_AVATARAUDIO_DOWNLOADABLEAVATARANIMATIONS._serialized_end = (
        2468
    )
